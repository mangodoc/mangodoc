...
## 2025-01-xx
1. 升级mangodoc版本到2.4.4。
2. 支持内置颜色标签。
3. 增强代码和代码块。
4. 升级到2.4.501，修复url重新刷新后无法定位到左侧菜单的问题，并适配如日志等不在左侧菜单的页面无法定位的问题。

## 2024-03-08
1. 升级mango-valine版本到1.2.2，修复刷新首次进入页面评价加载不出来的问题。
2. 修复guide/cover里的图片路径问题。
3. 抽取default和simple中公共的插件，提高代码复用性。
4. 发布2.4.1版本。
5. 完善文档，新增工具目录，完善脚手架和模板仓库的链接。
6. 新增友情链接，[elementui](https://element.eleme.cn/#/zh-CN/component/installation)

## 2024-03-05
1. 更新主页架构图说明，将脚手架和模板加入到生态中。

## 2024-02-25
1. 发布2.4.0版本，支持内置插件alert、link、tab等格式。

## 2024-02-24
1. 发布2.2.7版本，内置pageconfig插件，支持自定义页面配置。
2. 升级valine插件版本到1.1.1，读取页面配置的comment属性，来支持自定义评论系统的启用和关闭。
3. 升级busuanzi版本到1.1.2，调整字体为12px。
4. 升级update-time版本到1.0.4，调整整体为12px。

## 2024-02-20
1. 升级imgview到1.0.5版本，限制container下的img才做缩放动作，修复图片缩放问题。
